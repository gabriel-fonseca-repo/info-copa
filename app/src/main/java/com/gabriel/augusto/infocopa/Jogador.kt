...
class Jogador(var nomeJogador: String, var idJogador: Int, var idTime: Int, var idade: Int, var posicao: String, var participacoes: Int, var titulos: String, var clubes: String, var fotoJogador: String) {
